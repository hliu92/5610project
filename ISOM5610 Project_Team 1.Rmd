...
summary(fit.step)
# the stepwise result suggests all 8 predictors are useful
```
...
# from the interaction plots, we can find at least minor interaction effects for all 6 pairs. Especially, we suspect there may be significant interactions between the follwoing pairs:
# (1)Brand:Power
# (2)Brand:Region
# (3)Region:Power
# (4)Power:Gas
